...
def process_json_directory(directory_path):
    ...
    if all_data:
        ...
        plt.title(f'Frequency of Items from demo')
...
# Example usage
directory_path = "/Users/lily/Documents/2024-2025 Spring/algorithm_lab/cadinality_estimation/COMP3022_Project/dataset/demo"
process_json_directory(directory_path)